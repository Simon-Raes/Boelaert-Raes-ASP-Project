...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="panel panel-default" id="Div1" runat="server">
            ...
            <asp:Panel ID="pnlNoEmail" runat="server" DefaultButton="btnSend" >
                ...
                <p>Enter the emailaddress you've used to create your account. We'll send you an email with a link for account activation.</p>                <asp:TextBox ID="txtEmail" runat="server"></asp:TextBox>
