...
namespace LayeredBusinessModel.WebUI.wsCurrencyWebService {
    using System;
    ...
    [System.Web.Services.WebServiceBindingAttribute(Name="CurrencyWebServiceSoap", Namespace="http://tempuri.org/")]
    public partial class CurrencyWebService : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public CurrencyWebService() {
            this.Url = global::LayeredBusinessModel.WebUI.Properties.Settings.Default.LayeredBusinessModel_WebUI_wsCurrencyWebService_CurrencyWebService;
        ...
        /// <remarks/>
        public void convertAsync(float price, string currency) {
            this.convertAsync(price, currency, null);
        }
        
        /// <remarks/>
        public void convertAsync(float price, string currency, object userState) {
            ...
            this.InvokeAsync("convert", new object[] {
                        price,
                        currency}, this.convertOperationCompleted, userState);
        }
